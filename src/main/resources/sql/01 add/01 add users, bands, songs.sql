...
VALUES
    ...
    -- Estrada
    (7000, 'Позови меня с собой', 350, 'C#m'),
    (7010, 'Давай за...', 355, null),
    (7020, 'Конь', 355, 'Dm'),
    (7030, 'Позови меня тихо по имени', 355, 'Bm'),
    (7040, 'Ты неси меня река (Краса)', 355, null),
    (7050, 'Зеленоглазое такси', 360, 'Dm'),
    (7060, 'Ланфрен-ланфра', 360, null),
    (7070, 'Беловежская пуща', 365, null),
    (7080, 'Белоруссия', 365, 'Dm'),
    (7090, 'Полонез', 365, null),
    (7100, 'Там, где клён шумит', 370, 'Bm'),
    (7110, 'Прекрасное далёко', 375, 'Am'),
    (7120, 'Фантазёр', 380, null),

    -- Chanson
    (8000, 'Владимирский централ', 385, 'Bm'),
    (8010, 'Девочка-пай', 385, null),
    (8020, 'Кольщик', 385, 'Dm'),
    (8030, 'Это было вчера', 385, null),
    (8040, 'Всё для тебя', 390, 'Bm'),
    (8050, 'Свеча', 390, null);