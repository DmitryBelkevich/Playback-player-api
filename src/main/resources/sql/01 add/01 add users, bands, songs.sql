...
VALUES (1, 'No Roots', 1, 'Bm'),
       ...
       -- Estrada
       (1750, 'Позови меня с собой', 270, 'C#m'),
       (1760, 'Давай за...', 280, null),
       (1770, 'Конь', 280, 'Dm'),
       (1780, 'Позови меня тихо по имени', 280, 'Bm'),
       (1790, 'Ты неси меня река (Краса)', 280, null),
       (1800, 'Зеленоглазое такси', 290, 'Dm'),
       (1810, 'Ланфрен-ланфра', 290, null),
       (1820, 'Беловежская пуща', 300, null),
       (1830, 'Белоруссия', 300, 'Dm'),
       (1840, 'Полонез', 300, null),
       (1850, 'Там, где клён шумит', 310, 'Bm'),
       (1860, 'Прекрасное далёко', 320, 'Am'),
       (1870, 'Фантазёр', 330, null),
