...
VALUES (1, 'No Roots', 1, 'Bm'),
       ...
       (75, 'Дурак и молния', 34, 'C#m'),
       (76, 'Ели мясо мужики', 34, 'Am'),
       (77, 'Жаль, нет ружья!', 34, 'Am'),
       (78, 'Камнем по голове', 34, 'Am'),
       (79, 'Кукла колдуна', 34, 'Dm'),
       (80, 'Лесник', 34, 'Am'),
       (81, 'Мёртвый Анархист', 34, 'Am'),
       (82, 'Наблюдатель', 34, null),
       (83, 'Проклятый старый дом', 34, 'Bm'),
       (84, 'Прыгну со скалы', 34, 'Dm'),
       (85, 'WWW', 35, 'Cm'),
       (86, 'В Питере - пить', 35, 'F#m'),
       (87, 'Терминатор', 35, null),
       (88, 'Хали-Гали', 36, 'Bm'),
       (89, 'Ау', 37, 'Am'),
       (90, 'Воины света', 37, 'Am'),
       (91, 'В платье белом', 37, 'Am'),
       (92, 'Грай', 37, 'Em'),
       (93, 'Евпатория', 37, 'C'),
       (94, 'Капитал', 37, 'Am'),
       (95, 'Манифест', 37, 'A'),
       (96, 'Не быць скотам!', 37, 'C'),
       (97, 'Belarus Freedom', 37, null),
       (98, 'Огоньки', 37, 'Am'),
       (99, 'Сочи', 37, 'Gm'),
       (100, 'Танцуй', 37, 'Gm'),
       (101, 'Шут', 37, 'Am'),
       (102, 'Яблони', 37, 'Em'),
       (103, 'Я верю', 37, 'Em'),
       (104, 'Зеленоглазое такси', 38, 'Dm'),
       (105, 'Кольщик', 39, 'Dm'),
       (106, 'ДЕВОЧКА С КАРЕ', 40, 'Cm'),
       (107, 'Владивосток 2000', 41, 'Am'),
       (108, 'Медведица', 41, 'Em'),
       (109, 'Дыхание', 42, null),
       (110, 'Крылья', 42, null),
       (111, 'Последнее письмо', 42, 'Am'),
       (112, 'Прогулки по воде', 42, null),
       (113, 'Скованные одной цепью', 42, null),
       (114, 'Я хочу быть с тобой', 42, null),
       (115, 'Дым сигарет с ментолом', 43, 'Gm'),
       (116, 'Я так соскучился', 44, 'Am'),
       (117, '30 лет', 45, 'Am'),
       (118, 'Демобилизация', 45, 'Gm'),
       (119, 'Пора домой', 45, 'Am'),
       (120, 'Туман', 45, 'Cm'),
       (121, 'Разбуры турмы муры', 46, 'F#m'),
       (122, 'Стены рухнут', 46, 'F#m'),
       (123, 'Там, где клён шумит', 47, 'Bm'),
       (124, 'Круги на воде', 48, 'Bm'),
       (125, 'Выхода нет', 49, 'Em'),
       (126, 'Линия жизни', 49, 'Em'),
       (127, 'Моё сердце', 49, 'D'),
       (128, 'Орбит без сахара', 49, 'Cm'),
       (129, 'Романс', 49, 'Dm'),
       (130, 'Половинка', 50, 'Dm'),
       (131, 'Ту-лу-ла', 51, 'C#m');