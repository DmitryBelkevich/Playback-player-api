...
VALUES
    ...
    (11630, 'Белые розы', 315, null),
    (11640, 'Детство', 315, null),
    (11650, 'Розовый вечер', 315, null),
    (111590, 'Седая ночь', 315, null),
    (111600, 'Дым сигарет с ментолом', 320, 'Gm'),
    (111610, 'Чистый лист', 320, null),
    (111620, 'На белом покрывале января', 325, null),
    (111630, 'Белая ночь', 330, 'D#m'),

    -- SynthPop
    (111640, 'Sweet Dreams (Are Made of This)', 335, 'Cm'),

    -- New school
    (1111590, 'Мама, я люблю', 340, null),
    (1111600, 'Твоему новому парню', 340, null),
    (1111620, 'ДЕВОЧКА С КАРЕ', 345, 'Cm'),
