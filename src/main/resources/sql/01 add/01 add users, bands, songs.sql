...
VALUES
       ...
       (687, 'ПММЛ', 171, null),
       (690, 'Хочешь?', 171, 'Dm'),
       (700, 'Группа крови', 176, 'F#m'),
       (710, 'Звезда по имени Солнце', 176, 'Am'),
       (720, 'Когда твоя девушка больна', 176, 'G'),
       (730, 'Кончится лето', 176, 'Em'),
       (735, 'Красно-жёлтые дни', 176, 'Bm'),
       (740, 'Кукушка', 176, 'Am'),
       (750, 'Мама, мы все тяжело больны', 176, 'Bm'),
       (755, 'Муравейник', 176, 'D'),
       (760, 'Пачка сигарет', 176, 'Em'),
       (770, 'Хочу перемен!', 176, 'F#m'),
       (790, 'Воспоминание о былой любви', 186, 'Em'),
       (800, 'Два вора и монета', 186, 'Bm'),
       (810, 'Два монаха в одну ночь', 186, 'Em'),
       (820, 'Дурак и молния', 186, 'C#m'),
       (830, 'Ели мясо мужики', 186, 'Am'),
       (840, 'Жаль, нет ружья!', 186, 'Am'),
       (850, 'Камнем по голове', 186, 'Am'),
       (860, 'Кукла колдуна', 186, 'Dm'),
       (870, 'Лесник', 186, 'Am'),
       (880, 'Мёртвый Анархист', 186, 'Am'),
       (890, 'Наблюдатель', 186, 'Em'),
       (900, 'Проклятый старый дом', 186, 'Bm'),
       (910, 'Прыгну со скалы', 186, 'Dm'),
       (920, 'WWW', 230, 'Cm'),
