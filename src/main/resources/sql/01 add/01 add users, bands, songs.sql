...
VALUES (1, 'No Roots', 1, 'Bm'),
       ...
       (916, 'Розовый вечер', 187, null),
       (917, 'Седая ночь', 187, null),
       (920, 'WWW', 190, 'Cm'),
       ...
       (1260, '30 лет', 245, 'Am'),
       (1265, 'Бомж', 245, null),
       (1270, 'Демобилизация', 245, 'Gm'),
       (1280, 'Лирика', 245, 'Gm'),
       (1290, 'Пора домой', 245, 'Am'),
       (1300, 'Туман', 245, 'Cm'),
       (1310, 'Разбуры турмы муры', 250, 'F#m'),
       (1320, 'Стены рухнут', 250, 'F#m'),
       (1330, 'Там, где клён шумит', 255, 'Bm'),
       (1340, 'Круги на воде', 260, 'Bm'),
       (1350, 'Выхода нет', 265, 'Em'),
       (1360, 'Линия жизни', 265, 'Em'),
       (1370, 'Моё сердце', 265, 'D'),
       (1380, 'Орбит без сахара', 265, 'Cm'),
       (1390, 'Романс', 265, 'Dm'),
       (1400, 'Половинка', 270, 'Dm'),
       (1410, 'Прекрасное далеко', 275, 'Am'),
       (1420, 'Ту-лу-ла', 280, 'C#m');