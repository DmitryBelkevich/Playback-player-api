...
VALUES
    ...
    (1175, 'Вояджер-1', 112, 'Dm'),
    (1177, 'Видели ночь', 113, null),
    ...
    (1480, 'Про дурачка', 156, null),
    (1490, 'Про мишутку (Песенка для Янки)', 156, null),
    ...
    (1611, 'Алюминиевые огурцы', 190, null),
    (1612, 'Апрель', 190, 'Em'),
    (1613, 'Бездельник 2 (С лицом нахала)', 190, null),
    (1614, 'Безъядерная зона', 190, null),
    (1615, 'В наших глазах', 190, null),
    (1616, 'Видели ночь', 190, null),
    (1617, 'Война', 190, null),
    (1618, 'Восьмиклассница', 190, null),
    (1619, 'Генерал', 190, null),
    (1620, 'Группа крови', 190, 'F#m'),
    (1623, 'Дерево', 190, null),
    (1625, 'Игра', 190, 'Am'),
    (1626, 'Закрой за мной дверь', 190, null),
    (1627, 'Завтра война', 190, null),
    ...
    (1702, 'Последний герой', 190, null),
    (1703, 'Песня без слов', 190, null),
    (1704, 'Печаль', 190, 'Bm'),
    (1705, 'Разреши мне', 190, null),
    (1706, 'Сказка', 190, null),
    (1712, 'Следи за собой', 190, 'Cm'),
    (1714, 'Спокойная ночь', 190, 'Am'),
    (1716, 'Стук', 190, null),
    (1718, 'Хочу перемен!', 190, 'F#m'),
    (1719, 'Электричка', 190, null),
    ...
    (2251, 'Напои меня водой', 253, null),

    (2252, 'Прости. Прощай. Привет', 255, null),
    (2255, 'Это пройдёт', 255, 'Cm'),
    ...
    (7043, 'Кофе - мой друг', 346, null),
    (7045, 'Самый дорогой человек', 346, null),
    (7047, 'Слишком влюблен', 346, null),
