...
VALUES (1, 'No Roots', 1, 'Bm', null),
       ...
       (9, 'Creep', 7, 'G', '1meCuIBWnawQwSBAk79cgnTxF9VvDqwsT'),--TEMP
       ...
       (103, 'Кольщик', 38, 'Dm', '1jNVE9F_7iBaSbyn1pCzMnHGdrX1hQOtJ'),--TEMP
       (104, 'ДЕВОЧКА С КАРЕ', 39, 'Cm', '1P7kxdPdtxzSueUMbDZKm-COhjveUvjRt'),
       (105, 'Владивосток 2000', 40, 'Am', '1Lp4x49dw1LFzzct_gLN8WFVtvG1eEDLv'),--TEMP
