...
VALUES
    ...
    (300, 'Песняры'),
    (310, 'Синяя птица'),
    (320, 'Татьяна Дасковская'),
    (330, 'Ярослав Евдокимов'),
...
VALUES (1, 'No Roots', 1, 'Bm'),
       ...
       -- Estrada
       (330, 'Позови меня с собой', 270, 'C#m'),
       (955, 'Давай за...', 280, null),
       (960, 'Конь', 280, 'Dm'),
       (965, 'Позови меня тихо по имени', 280, 'Bm'),
       (967, 'Ты неси меня река (Краса)', 280, null),
       (1120, 'Зеленоглазое такси', 290, 'Dm'),
       (1125, 'Ланфрен-ланфра', 290, null),
       (1246, 'Беловежская пуща', 300, null),
       (1247, 'Белоруссия', 300, 'Dm'),
       (1248, 'Полонез', 300, null),
       (1340, 'Там, где клён шумит', 310, 'Bm'),
       (1420, 'Прекрасное далёко', 320, 'Am'),
       (1440, 'Фантазёр', 330, null),

       -- Chanson
       (1880, 'Владимирский централ', 340, 'Bm'),
       (1890, 'Девочка-пай', 340, null),
       (1900, 'Кольщик', 340, 'Dm'),
       (1910, 'Это было вчера', 340, null),
       (1920, 'Всё для тебя', 350, 'Bm'),
       (1930, 'Свеча', 350, null),
