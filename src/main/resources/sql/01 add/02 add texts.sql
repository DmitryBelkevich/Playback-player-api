...
(DEFAULT, '1VRNtP7xjVVQZStlmwEOeQ1lk5e_NrOGj', 8),
-- Radiohead - Creep
(DEFAULT, '1meCuIBWnawQwSBAk79cgnTxF9VvDqwsT', 9),
...
(DEFAULT, '1pWTRd9J8w-o-R4ISAebN3vdfSwUazlb0', 19),
-- BRUTTO - 12 обезьян
-- (DEFAULT, '', 20),
-- IOWA - Бьёт Бит
-- (DEFAULT, '', 21),
...
-- (DEFAULT, '', 27),
-- Альянс - На заре
(DEFAULT, '1qsxOUZ-vt8B-6oJhbfbg-EezKGF4lczq', 28),
...
(DEFAULT, '1LlOHnnq-wIJewkeKhE-BV3E53LDGkXtA', 37),
-- Би-2 - Серебро
-- (DEFAULT, '', 38),
...
-- ДДТ - Просвистела
-- ДДТ - Что такое осень
(DEFAULT, '1bNemBk0c7_XenKj1Nx3SNbcDyexNAsAD', 51),
-- ДДТ - Это всё…
...
(DEFAULT, '1vtsCxcGLj6-O51ZjNEuMKt7TZw-GmjOK', 61),
-- Земфира - Искала
-- (DEFAULT, '', 62),
-- Земфира - Хочешь?
-- (DEFAULT, '', 63),
...
(DEFAULT, '1jsXRPufNyzu45Rx3y3MBBFka1LFQ0aIR', 73),
-- Король и Шут - Дурак и молния
-- (DEFAULT, '', 74),
-- Король и Шут - Ели мясо мужики
-- (DEFAULT, '', 75),
-- Король и Шут - Жаль, нет ружья!
(DEFAULT, '11CauXLbzrP3MuE5vIckNJA2bFNtnoRhs', 76),
...
(DEFAULT, '1J-4JkTNl-2QxLoTT6twWLzuOhfFoo9lS', 80),
...
-- (DEFAULT, '', 102),
-- Михаил Круг - Кольщик
(DEFAULT, '1jNVE9F_7iBaSbyn1pCzMnHGdrX1hQOtJ', 103),
-- МУККА - ДЕВОЧКА С КАРЕ
(DEFAULT, '1P7kxdPdtxzSueUMbDZKm-COhjveUvjRt', 104),
-- Мумий Тролль - Владивосток 2000
(DEFAULT, '1Lp4x49dw1LFzzct_gLN8WFVtvG1eEDLv', 105),
...
(DEFAULT, '1lL6BOSpselagLAFSTzCk4vLrVsfRAMBo', 114),
-- Сектор Газа - 30 лет
(DEFAULT, '1VH1TAITlCzMJ5kYZXR8wfvEQ-0SmH5kK', 115),
-- Сектор Газа - Демобилизация
-- (DEFAULT, '', 116),
-- Сектор Газа - Пора домой
(DEFAULT, '18BIop-OrduXX3qPAVjtbVUmuInJ8R2RY', 117),
-- Сектор Газа - Туман
(DEFAULT, '1dcEqgfBCl2ABVcwGlmTAs9lQFJSTpjnz', 118),
-- Сергей Тихановcкий & Kosmas - Разбуры турмы муры
-- (DEFAULT, '', 119),
-- Сергей Тихановcкий & Kosmas - Стены рухнут
-- (DEFAULT, '', 120),
-- Синяя птица - Там, где клён шумит
(DEFAULT, '1jU1OELMO1mB8-e40pxr9ibZ8DdPXGQIK', 121);
-- Слот - Круги на воде
-- (DEFAULT, '', 122),
-- Сплин - Выхода нет
-- (DEFAULT, '', 123),
