...
(DEFAULT, '1VRNtP7xjVVQZStlmwEOeQ1lk5e_NrOGj', 9),
-- Radiohead - Creep
(DEFAULT, '1meCuIBWnawQwSBAk79cgnTxF9VvDqwsT', 10),
...
(DEFAULT, '1ATCfsprwO6poFwFtURq49JXPPRen5V_8', 14),
-- System of a Down - Chop Suey!
(DEFAULT, '1gKDBLRqf4fkymtkPNcMbDSxrW18D5Sep', 15),
-- System of a Down - Lonely Day
(DEFAULT, '17QY2dfSxTkUwyGcL9Ovrtqtsh7vrOay2', 16),
-- System of a Down - Toxicity
(DEFAULT, '1Vr2z7DHr02lC4lgD7lXaUA-M_wvBLsQz', 17),
...
(DEFAULT, '1pWTRd9J8w-o-R4ISAebN3vdfSwUazlb0', 22),
-- BRUTTO - 12 обезьян
-- (DEFAULT, '', 23),
-- IOWA - Бьёт Бит
-- (DEFAULT, '', 24),
...
-- (DEFAULT, '', 30),
-- Альянс - На заре
(DEFAULT, '1qsxOUZ-vt8B-6oJhbfbg-EezKGF4lczq', 31),
...
(DEFAULT, '1LlOHnnq-wIJewkeKhE-BV3E53LDGkXtA', 40),
-- Би-2 - Серебро
-- (DEFAULT, '', 41),
...
-- ДДТ - Просвистела
-- ДДТ - Что такое осень
(DEFAULT, '1bNemBk0c7_XenKj1Nx3SNbcDyexNAsAD', 54),
-- ДДТ - Это всё…
...
(DEFAULT, '1vtsCxcGLj6-O51ZjNEuMKt7TZw-GmjOK', 64),
-- Земфира - Искала
-- (DEFAULT, '', 65),
-- Земфира - Хочешь?
-- (DEFAULT, '', 66),
...
(DEFAULT, '1jsXRPufNyzu45Rx3y3MBBFka1LFQ0aIR', 76),
-- Король и Шут - Два вора и монета
(DEFAULT, '10vIdFb5RUWn6lmTLBOvTLSLSt3KOdv29', 77),
-- Король и Шут - Два монаха в одну ночь
(DEFAULT, '1I0MBK0Uti5hIxeRLRPCpArwfxzlGaPiH', 78),
-- Король и Шут - Дурак и молния
-- (DEFAULT, '', 79),
-- Король и Шут - Ели мясо мужики
-- (DEFAULT, '', 80),
-- Король и Шут - Жаль, нет ружья!
(DEFAULT, '11CauXLbzrP3MuE5vIckNJA2bFNtnoRhs', 81),
-- Король и Шут - Камнем по голове
(DEFAULT, '1AcMMUVVFsj5Ec7IqyMzEBl7I3TpzqPjC', 82),
-- Король и Шут - Кукла колдуна
-- (DEFAULT, '', 83),
-- Король и Шут - Лесник
-- (DEFAULT, '', 84),
-- Король и Шут - Мёртвый Анархист
(DEFAULT, '1J-4JkTNl-2QxLoTT6twWLzuOhfFoo9lS', 85),
-- Король и Шут - Наблюдатель
(DEFAULT, '15K64bOm9D7AOHf6RqOuCb4kT2-vPMvff', 86),
-- Король и Шут - Проклятый старый дом
(DEFAULT, '1RuJJGH48mhyJU9Hn8v66jKxYR6hR5ZJU', 87),
...
-- (DEFAULT, '', 108),
-- Михаил Круг - Кольщик
(DEFAULT, '1jNVE9F_7iBaSbyn1pCzMnHGdrX1hQOtJ', 109),
-- МУККА - ДЕВОЧКА С КАРЕ
(DEFAULT, '1P7kxdPdtxzSueUMbDZKm-COhjveUvjRt', 110),
-- Мумий Тролль - Владивосток 2000
(DEFAULT, '1Lp4x49dw1LFzzct_gLN8WFVtvG1eEDLv', 111),
