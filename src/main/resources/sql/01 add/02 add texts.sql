...
(DEFAULT, '1pWTRd9J8w-o-R4ISAebN3vdfSwUazlb0', 20),
-- BRUTTO - 12 обезьян
-- (DEFAULT, '', 21),
-- IOWA - Бьёт Бит
-- (DEFAULT, '', 22),
...
-- (DEFAULT, '', 28),
-- Альянс - На заре
(DEFAULT, '1qsxOUZ-vt8B-6oJhbfbg-EezKGF4lczq', 29),
...
(DEFAULT, '1LlOHnnq-wIJewkeKhE-BV3E53LDGkXtA', 38),
-- Би-2 - Серебро
-- (DEFAULT, '', 39),
...
-- ДДТ - Просвистела
-- ДДТ - Что такое осень
(DEFAULT, '1bNemBk0c7_XenKj1Nx3SNbcDyexNAsAD', 52),
-- ДДТ - Это всё…
...
(DEFAULT, '1vtsCxcGLj6-O51ZjNEuMKt7TZw-GmjOK', 62),
-- Земфира - Искала
-- (DEFAULT, '', 63),
-- Земфира - Хочешь?
-- (DEFAULT, '', 64),
...
(DEFAULT, '1I0MBK0Uti5hIxeRLRPCpArwfxzlGaPiH', 75),
-- Король и Шут - Дурак и молния
-- (DEFAULT, '', 76),
-- Король и Шут - Ели мясо мужики
-- (DEFAULT, '', 77),
-- Король и Шут - Жаль, нет ружья!
(DEFAULT, '11CauXLbzrP3MuE5vIckNJA2bFNtnoRhs', 78),
...
(DEFAULT, '1J-4JkTNl-2QxLoTT6twWLzuOhfFoo9lS', 82),
-- Король и Шут - Наблюдатель
(DEFAULT, '15K64bOm9D7AOHf6RqOuCb4kT2-vPMvff', 83),
...
-- (DEFAULT, '', 105),
-- Михаил Круг - Кольщик
(DEFAULT, '1jNVE9F_7iBaSbyn1pCzMnHGdrX1hQOtJ', 106),
-- МУККА - ДЕВОЧКА С КАРЕ
(DEFAULT, '1P7kxdPdtxzSueUMbDZKm-COhjveUvjRt', 107),
-- Мумий Тролль - Владивосток 2000
(DEFAULT, '1Lp4x49dw1LFzzct_gLN8WFVtvG1eEDLv', 108),
...
(DEFAULT, '1lL6BOSpselagLAFSTzCk4vLrVsfRAMBo', 117),
-- Сектор Газа - 30 лет
(DEFAULT, '1VH1TAITlCzMJ5kYZXR8wfvEQ-0SmH5kK', 118),
-- Сектор Газа - Демобилизация
-- (DEFAULT, '', 119),
-- Сектор Газа - Пора домой
(DEFAULT, '18BIop-OrduXX3qPAVjtbVUmuInJ8R2RY', 120),
-- Сектор Газа - Туман
(DEFAULT, '1dcEqgfBCl2ABVcwGlmTAs9lQFJSTpjnz', 121),
-- Сергей Тихановcкий & Kosmas - Разбуры турмы муры
-- (DEFAULT, '', 122),
-- Сергей Тихановcкий & Kosmas - Стены рухнут
-- (DEFAULT, '', 123),
-- Синяя птица - Там, где клён шумит
(DEFAULT, '1jU1OELMO1mB8-e40pxr9ibZ8DdPXGQIK', 124);
-- Слот - Круги на воде
-- (DEFAULT, '', 125),
-- Сплин - Выхода нет
-- (DEFAULT, '', 126),
