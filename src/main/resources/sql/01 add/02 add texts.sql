...
(DEFAULT, '11CauXLbzrP3MuE5vIckNJA2bFNtnoRhs', 77),
...
(DEFAULT, '1J-4JkTNl-2QxLoTT6twWLzuOhfFoo9lS', 81),
-- Король и Шут - Наблюдатель
(DEFAULT, '15K64bOm9D7AOHf6RqOuCb4kT2-vPMvff', 82),
...
-- (DEFAULT, '', 104),
-- Михаил Круг - Кольщик
(DEFAULT, '1jNVE9F_7iBaSbyn1pCzMnHGdrX1hQOtJ', 105),
-- МУККА - ДЕВОЧКА С КАРЕ
(DEFAULT, '1P7kxdPdtxzSueUMbDZKm-COhjveUvjRt', 106),
-- Мумий Тролль - Владивосток 2000
(DEFAULT, '1Lp4x49dw1LFzzct_gLN8WFVtvG1eEDLv', 107),
...
(DEFAULT, '1lL6BOSpselagLAFSTzCk4vLrVsfRAMBo', 116),
-- Сектор Газа - 30 лет
(DEFAULT, '1VH1TAITlCzMJ5kYZXR8wfvEQ-0SmH5kK', 117),
-- Сектор Газа - Демобилизация
-- (DEFAULT, '', 118),
-- Сектор Газа - Пора домой
(DEFAULT, '18BIop-OrduXX3qPAVjtbVUmuInJ8R2RY', 119),
-- Сектор Газа - Туман
(DEFAULT, '1dcEqgfBCl2ABVcwGlmTAs9lQFJSTpjnz', 120),
-- Сергей Тихановcкий & Kosmas - Разбуры турмы муры
-- (DEFAULT, '', 121),
-- Сергей Тихановcкий & Kosmas - Стены рухнут
-- (DEFAULT, '', 122),
-- Синяя птица - Там, где клён шумит
(DEFAULT, '1jU1OELMO1mB8-e40pxr9ibZ8DdPXGQIK', 123);
-- Слот - Круги на воде
-- (DEFAULT, '', 124),
-- Сплин - Выхода нет
-- (DEFAULT, '', 125),
