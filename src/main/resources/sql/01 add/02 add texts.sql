...
(DEFAULT, '1N3cfvUS9N8TQ1ynkL03w5ETIjObV_Oy6', 5),
...
(DEFAULT, '1lTF7MavAIOgyb-Iv1SkXNCb-Ogxs32eY', 168),
-- Кипелов - Я свободен!
...
(DEFAULT, '11jS131731HTdqY3zDg9MYkAOCPukz1kM', 1035),
-- Radiohead - Creep
...
(DEFAULT, '1x5T1NPPQNwXNdZdPFAhX-l0UmCvPF3th', 1350),
-- Гражданская оборона - Мы идём в тишине
(DEFAULT, '12trdG-MIAovz62NKfzTnKo20y6ju7qmo', 1355),
...
(DEFAULT, '1iWx220gXtTmht53oKfs1UEss4ayC14m_', 1375),
-- Гражданская оборона - Про дурачка
(DEFAULT, '1_ctu7jhSDjOxp6u_UwkV2P_jcyQL_ihP', 1380),
...
-- ДДТ - Песня о свободе
(DEFAULT, '16aKcIs5KRKdCVonSW8lYWjWQBSEywFjP', 1445),
-- ДДТ - Просвистела
...
-- Zемфира - Москва
(DEFAULT, '1GGN-RCssbl0fWojj51OF7Z5QMtApy-cx', 1582),
-- Zемфира - П.М.М.Л.
...
(DEFAULT, '1uI0nh8W9ZEqqvARgG6-TVYVRHe7L1G0U', 1626),
-- Кино - Завтра война
(DEFAULT, '1WmiwW0_itVW0zQgNvXOGQ_mSEn7arpB6', 1627),
...
-- Кино - Легенда
(DEFAULT, '1sQJtOr9DwGGO9oud-cZFbHrPjB-JJp40', 1673),
-- Кино - Мама - Анархия
...
-- Кино - Стук
(DEFAULT, '128ejDzf1lijy2vseR56OQ3tfKkAQNgcJ', 1716),
-- Кино - Хочу перемен!
...
(DEFAULT, '1I0MBK0Uti5hIxeRLRPCpArwfxzlGaPiH', 1735),
-- Король и Шут - Дурак и молния
(DEFAULT, '1MuDgDO6W9uUF_pPPpsFJy5ArtAvv6lMP', 1740),
...
(DEFAULT, '1kTHfdO6AAGLh7VyZohTmU1KUjDCYzto-', 1805),
...
(DEFAULT, '19-rFZWto5BcGB4Bc8eNgl9ho8cGpiZo3', 2031),
-- Ляпис Трубецкой - Золотая антилопа
(DEFAULT, '1S9rnuthY2O9Eo8BMBGu7v6On3eTgI2td', 2035),
-- Ляпис Трубецкой - Зорачкі
(DEFAULT, '1n0Rtr2BIv6SH1KYSd7etfL2Bngk7v5We', 2037),
...
(DEFAULT, '1I7MQ5w6dR56JvWO8y0kcuOwayvuUL-Zs', 2100),
...
(DEFAULT, '1xHCcPJZJcdafgT4Yl_otUrLal3ykTinC', 5003),
-- Coolio - Gangsta's Paradise
(DEFAULT, '1puIg5VloL6vLh3jk-JNMmXRqb0H3crSD', 5004),
-- Leonard Cohen - Hallelujah
(DEFAULT, '1VD52hIwXCGD4F4Xf4trfO2TMU1ySAQQw', 5005),
-- Nathan Evans - Wellerman (Sea Shanty)
(DEFAULT, '1HExQ3Fzoqmpm7sFF0MyJKdRoNHdCtSGb', 5007),
-- Maroon 5 - This Love
-- (DEFAULT, '', 5010),
-- IOWA - Бьёт Бит
-- (DEFAULT, '', 5020),
...
-- Евгений Дога - Вальс
(DEFAULT, '1rQyZVe91ODaghV5tlBrOS1312AvT20J2', 10110),

-- Bach Johann Sebastian - Orchestral Suite No.2 in B Minor, BWV 1067 - Badinerie
(DEFAULT, '1LqVEYKwlSIimjB32A9vIjItKX6SxnzlY', 10120),
-- Bach Johann Sebastian - Suite in E minor, BWV 996 - Bourree
(DEFAULT, '12SJgtz75coT9bWrfg_GtB3Ppltp_Bv1J', 10125),
