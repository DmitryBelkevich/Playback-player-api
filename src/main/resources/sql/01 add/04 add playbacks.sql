...
(DEFAULT, 'original', '1hmlFLGlqYwGBQPJ_t5_NVIDOrHpiucJv', 5),
...
-- Stigmata - Сентябрь
(DEFAULT, 'original', '1M7-TI9E6wP2mGopBQcTw8rJFTFJyfR-n', 185),
-- Эпидемия - Эпилог
(DEFAULT, 'original', '1E84n8-a5oSY1MELRxB8C-Gs2GDVLp1cV', 200),
(DEFAULT, '0', '11NKNmXA6e1X45W662MNm0Hr8joc244IC', 200),
(DEFAULT, '-1', '1tkg3bfWPpjZTzf1EKGB4PP3v8fOs96N6', 200),
...
(DEFAULT, '0', '1Q8-vhGoOyjYLf8Z-t-pmolXnld50jTmg', 1035),
-- Radiohead - Creep
...
(DEFAULT, 'original', '1aDBJPN-CTsOMrHbdk2_HnEW9JFgf6ATb', 1340),
-- Гражданская оборона - Мёртвые
-- Гражданская оборона - Мы идём в тишине
(DEFAULT, 'original', '1e-SX0VH-Sds94yGsssm8lAODG3aCSOvN', 1355),
(DEFAULT, '0', '1Bh_rJpood3hLPX3GcZFUYg8K7ymz7xAf', 1355),
...
(DEFAULT, '0', '1QW41wsh38PQ_GjVcAvfF2233E2GND8q_', 1380),
...
-- ДДТ - Осенняя
(DEFAULT, 'original', '1ZtBQG36WbdYKnviF2mELhmO7cCwp5TcT', 1440),
(DEFAULT, '0', '1oCtjZP1bSLWlwNd2P9bn5aRPFO0jlY8l', 1440),
-- ДДТ - Пацаны
...
(DEFAULT, '0', '1CmzTQh780eP0vM19xwfK0L1aMZzqi4LY', 1445),
(DEFAULT, '-2', '1h5fXJx9yeX4Z5kOmBc4R_9aESNKDJ70z', 1445),
(DEFAULT, '-3', '1H-OP9R2DvV_K6MhS7SQxkBqeiTHB0_kZ', 1445),
-- ДДТ - Просвистела
...
-- Кино - Легенда
(DEFAULT, 'original', '1vHnJ2K55_Jhc0vYmub6DmJSYJmJuMxHC', 1673),
-- Кино - Мама - Анархия
...
(DEFAULT, '0', '13c2v7aDB9hcDwpIeUvueiPiOqNo7rIiy', 1721),
...
(DEFAULT, '-3', '1oPyBdBJ23g7UoxE5NCbJgppGAOuQy2Qc', 1723),
...
(DEFAULT, 'original', '1hlVS0oVZRNvEktVhQXKlu3Z5uZtXjE5R', 1727),
...
(DEFAULT, '0', '1EWm8Kit4Bu4ZTx_0CcHSlGKHjD0jS7Ph', 1967),
...
(DEFAULT, '0', '1iYs2co518AK064gXh5_A6z3EPsif05jr', 1980),
...
(DEFAULT, '0', '1OdwsmaCYxVcGfS-0bmyTnxHtFUGpIs2t', 2010),
...
(DEFAULT, '0', '1Wq3paact3z9Fhz8DqL73z2O8NXxxYRJv', 2110),
-- Ляпис Трубецкой - Шут
...
(DEFAULT, 'original', '19nLKDywTFnyoimw0k5_M2gFH6vqfdu-Q', 2145),
...
(DEFAULT, '0', '1HLCuEhJWDRaYlW8go1Xil38lXCol1RYb', 2160),
...
(DEFAULT, '0', '1s6hR7Tmhpg0SxS8OhXvju6NItEq37ixW', 2230),
...
(DEFAULT, 'original', '1PxBFJCSi_6P4k7m8zDxw804vPyaBY3AP', 2275),
...
(DEFAULT, '0', '1eqfCR7JJJgTt3Je52EPPH0r5pm4NpxBN', 2329),
...
(DEFAULT, '0', '1bDDZaC6DVcZoEYieMDYrRgW0Dn4kleW5', 2390),
...
(DEFAULT, '0', '1wmvBiLTTcA9OK4yKj15AwwqAm9tL5BLc', 3030),
...
(DEFAULT, '-2', '1HMuVAtq9wLCfGNp7GArsoJ9wVlklY_6v', 5004),
...
(DEFAULT, 'original', '1RhWqCOI8196eAUb41Mh9qWDeOSyVdix2', 5825),
(DEFAULT, '0', '1asKt9t7WgEgBzI0ZbKpdmAG63A9Ijryz', 5825),
...
(DEFAULT, '1', '1FscPQT7nhC3M4476bFqncKRQjRYeNcdn', 8050),
(DEFAULT, '0', '1_urxOxEtukE8n0jtrA16oT7GO20Pjm2h', 8050),
...
(DEFAULT, '0', '1Dpx2eDIw901pIJO13yNfRRYU3dMIwpAB', 8117),
(DEFAULT, '-2', '1lojOsTpVzge1SUZAU-JSQeDLVlT67IMC', 8117),
...
(DEFAULT, 'original', '1vOtGaOjk6XQcEPQAxjapIJ_Ipw7BgCtn', 10060),
