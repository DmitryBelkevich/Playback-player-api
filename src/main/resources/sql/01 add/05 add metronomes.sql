...
-- Любэ - Конь
(DEFAULT, null, 4, 4, 80, 960),
-- Любэ - Позови меня тихо по имени
(DEFAULT, null, 6, 8, 60, 965),
-- Ляпис Трубецкой - Ау
...
(DEFAULT, null, 2, 4, 65, 1340),
-- Слот - Круги на воде
(DEFAULT, null, 4, 4, 71, 1350),
-- Сплин - Выхода нет
(DEFAULT, null, 4, 4, 86, 1360),
-- Сплин - Линия жизни
(DEFAULT, null, 4, 4, 105, 1370),
-- Сплин - Моё сердце
(DEFAULT, null, 4, 4, 131, 1380),
-- Сплин - Орбит без сахара
(DEFAULT, null, 4, 4, 136, 1390),
-- Сплин - Романс
(DEFAULT, null, 4, 4, 100, 1400),
-- Стас Михайлов - Всё для тебя
(DEFAULT, null, 4, 4, 138, 1405),
-- Танцы Минус - Половинка
(DEFAULT, null, 2, 4, 87, 1410),
-- Татьяна Дасковская - Прекрасное далёко
(DEFAULT, null, 4, 4, 100, 1420),
-- Форум - Белая ночь
