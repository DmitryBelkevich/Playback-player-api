...
-- Би-2 - Мой рок-н-ролл
(DEFAULT, null, 2, 4, 60, 1260),
(DEFAULT, 'Interlude', 4, 8, 120, 1260),
(DEFAULT, 'Interlude', 5, 8, 120, 1260),
...
(DEFAULT, null, 4, 4, 184, 1719),
-- Король и Шут - Воспоминание о былой любви
(DEFAULT, 'Intro', 2, 2, 58, 1720),
(DEFAULT, 'Verse', 4, 4, 117, 1720),
-- Король и Шут - Воспоминание о былой любви (Instrumental)
(DEFAULT, null, 4, 4, 118, 1721),
...
(DEFAULT, 'Verse', 4, 4, 178, 1750),
(DEFAULT, 'Chorus, Solo', 8, 8, 356, 1750),
...
(DEFAULT, null, 4, 4, 75, 2255),
-- Нервы - Слишком влюблен
(DEFAULT, null, 4, 4, 85, 2257),
-- Порнофильмы - Прости. Прощай. Привет
(DEFAULT, null, 4, 4, 126, 2260),
-- Порнофильмы - Это пройдёт
(DEFAULT, null, 4, 4, 165, 2262),
(DEFAULT, null, 2, 2, 82, 2262),
-- Порнофильмы - Я так соскучился
(DEFAULT, null, 6, 8, 64, 2265),
-- Сектор Газа - 30 лет
...
(DEFAULT, null, 4, 4, 118, 5040),
-- Ласковый май - Розовый вечер
(DEFAULT, null, 4, 4, 0, 5060),
-- Ласковый май - Седая ночь
(DEFAULT, null, 4, 4, 118, 5070),
